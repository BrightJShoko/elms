...
const adminlogin = () => {
  ...
  return (
    <div className="bg-[#00913E]  shadow p-4 w-[100%] h-screen items-center flex justify-center overflow-hidden relative flex-col ">
      ...
      <div className="bg-white rounded-lg shadow p-4 pt-[90px] flex flex-col items-center content-center mt-[4%]">
      ...
      <Link
        href="/"
        className=" w-[39%] p-[20px] bg-white mt-5 rounded-lg text-[#00913E]  text-center"
      >
        Go To Home
      </Link>
    </div>
